...
uint256 hashGenesisBlock("0x03466d6e2979ae36a14382d495d7ec1f5f8564668ab801f9b23ceb100b57f149");
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x714538be39de74100c0a14bbd52f22a9736582926186818485a60c84a7905165");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("3cc10d629fe855c1a775dc20ea6500e14e64a36ea2ccf87156c63ff9c0f06b4aae2f98d0f6ab181f788212dc1e1f26d9a3ffde75cd4932c033fd60b80f8b1cb8ec") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1539096369;
        block.nBits    = 504365644;
        block.nNonce   = 3849892058;

        if (fTestNet)
        {
            block.nTime    = 1539096369;
            block.nNonce   = 655371777;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x3c88791e0a2a107fa5d12832dc6e16d4b6b7ff7db69cd1d0c91a3e829e402d95"));
        block.print();
